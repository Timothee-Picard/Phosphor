       ...
       <FooterCustom>
           ...
           <div className={styles.globalContainer}>
               <section className={styles.hero}>
                   <Image src={"/projects/prenom/hero.png"} alt={"aaa"} width={2880} height={1030} priority/>
               </section>
               <section className={styles.sectionInfos}>
                   <div className={styles.sectionInfosTitle}>
                       <h1>Prénom</h1>
                       <p>Website / App mobile / Charte graphique</p>
                   </div>
                   ...
                   <div className={styles.sectionInfosSubGeneralContainer}>
                       ...
                       <div className={styles.sectionInfosImage}>
                           <Image src={"/projects/prenom/mockup.png"} alt={"aaa"} width={1794} height={1248} priority/>
                       </div>
                   </div>
               </section>
               <section className={styles.hero}>
                   <Image src={"/projects/prenom/hero2.png"} alt={"aaa"} width={2880} height={926}/>
               </section>
               <section className={styles.sectionContact}>
                   <div className={styles.sectionContactImage}>
                       <Image src={"/projects/prenom/mockup2.png"} alt={"aaa"} width={1360} height={1490}/>
                   </div>
